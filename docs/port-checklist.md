...
- GitHub repo URL: https://github.com/polycpp/ini
...
- [x] strict readiness passed (see Step 7 of the catch-up output)
...
- [ ] production-grade quality confirmed (depends on resolving audit findings AF-2026-05-04-A through I)
- [ ] port version is at least `1.0.0`
